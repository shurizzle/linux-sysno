...
pub enum Sysno {
    ...
    set_thread_area = 334,
    /// See doc at [atomic_cmpxchg_32(2)](https://man7.org/linux/man-pages/man2/atomic_cmpxchg_32.2.html).
    atomic_cmpxchg_32 = 335,
    /// See doc at [atomic_barrier(2)](https://man7.org/linux/man-pages/man2/atomic_barrier.2.html).
    atomic_barrier = 336,
