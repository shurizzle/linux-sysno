...
pub enum Sysno {
    ...
    acct = 51,
    /// See doc at [memory_ordering(2)](https://man7.org/linux/man-pages/man2/memory_ordering.2.html).
    memory_ordering = 52,
    ...
    setdomainname = 163,
    /// See doc at [utrap_install(2)](https://man7.org/linux/man-pages/man2/utrap_install.2.html).
    utrap_install = 164,
